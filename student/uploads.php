		...
		<div class="row">
			...
			<div class="row">
				<?php
					...
					if ($el->exists ()){
				?>
				<p style="border: thin #7CCD7C solid; padding: 10px; background:#E0EEE0;"><?php echo $el->getResponse (); ?></p>
				<?
					}
				?>
			</div>
			
			<!-- Why does this section refer to blog start-->
			...
			<!-- Why does this section refer to blog end-->
			...
			<div class="col s10 m12 offset-s1 card">
				<div class="card-content">
					...
					<p class="green-text">You have uploaded <?php echo $file_count; ?> files</p>
					<ul class="collection">
